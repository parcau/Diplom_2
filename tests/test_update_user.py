...
class TestUpdateUser:
    @allure.step("Проверяем обновления информации о пользователе авторизовавшись")
    @allure.description(
    ...
    @allure.step("Проверяем обновление информации о пользователе не авторизовавшись")
    @allure.description(
